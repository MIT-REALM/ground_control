...
#include <rgc_simulator/Pose2dArray.h>
#include <geometry_msgs/PoseWithCovarianceStamped.h>
#include <geometry_msgs/PoseStamped.h>
#include <geometry_msgs/PointStamped.h>
#include <sensor_msgs/LaserScan.h>

#include "rgc_simulator/ackermann_kinematics.hpp"
#include "rgc_simulator/scan_simulator_2d.hpp"

#include "rgc_simulator/car_state.hpp"
#include "rgc_simulator/car_params.hpp"
#include "rgc_simulator/config.h"
#include "rgc_simulator/ks_kinematics.hpp"
#include "rgc_simulator/st_kinematics.hpp"
#include "rgc_simulator/precompute.hpp"
...
private:
    ...
    rgc_simulator::Pose2dArray all_poses;
...
public:
    ...
    Racecar(): n(std::make_shared<ros::NodeHandle>(ros::NodeHandle("~")))
    {
        ...
        all_pose_pub = n->advertise<rgc_simulator::Pose2dArray>(all_pose_topic, 1);
        ...
        {
            all_poses.poses.emplace_back(rgc_simulator::Pose2d{});
        }
    ...
    double get_range(const rgc_simulator::Pose2d &pose, double beam_theta, Eigen::Vector2d& la, Eigen::Vector2d& lb)
    {
    ...
    void ray_cast_opponents(std::vector<float> &scan, const rgc_simulator::Pose2d &scan_pose)
    {
    ...
    void update_pose(const ros::TimerEvent&)
    {
        if(active_car_idx == 0 || active_car_idx == rcid)
        {
            ...
            if (map_exists)
            {
                ...
                rgc_simulator::Pose2d scan_pose;
                ...
                rgc_simulator::Pose2d current_state;
    ...
    void pose_callback(const geometry_msgs::PoseStamped& msg)
    {
        if(active_car_idx == 0 || active_car_idx == rcid)
        {
            ...
            rgc_simulator::Pose2d current_pose;
    ...
    void all_pose_callback(const rgc_simulator::Pose2dArray& all_poses_update)
    {
        for(size_t i=0; i<config::n_agents; i++)
        {
            if(i != (rcid-1))
    ...
    void drive_callback(const f1tenth_msgs::F1TenthDriveStamped & msg)
    {
        if(active_car_idx == 0 || active_car_idx == rcid)
        {
...
{
    ros::init(argc, argv, "rgc_simulator");
    Simulator simulator;
    ros::spin();
    return 0;
}
