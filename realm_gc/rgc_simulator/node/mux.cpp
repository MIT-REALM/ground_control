...
public:
    Mux()
    {
        ...
        drive_pub = n.advertise<f1tenth_msgs::F1TenthDriveStamped>(drive_topic, 10);
    ...
    void publish_to_drive(double desired_velocity, double desired_steer) {
        ...
        f1tenth_msgs::F1TenthDriveStamped drive_st_msg;
        f1tenth_msgs::F1TenthDrive drive_msg;
...
: mux_idx(mux_idx_), mp_mux(mux) {
    ...
    drive_pub = mux->n.advertise<f1tenth_msgs::F1TenthDriveStamped>(drive_topic, 10);
...
void Channel::drive_callback(const f1tenth_msgs::F1TenthDriveStamped & msg)
{
