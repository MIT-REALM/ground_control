...
To run the simulator on its own, run:
    ...
    roslaunch rgc_simulator simulator.launch
...
![Simplified graph of ROS nodes](https://raw.githubusercontent.com/f1tenth/f110_ros/master/rgc_simulator/media/sim_graph_public.png)
...
<launch>
  ...
  <group ns="racecar1">
    <!-- Open the model file -->
    <arg name="racecar_xacro" default="$(find rgc_simulator)/racecar.xacro"/>
...
2.  **Config File** (include/rgc_simulator/config.h)
```
