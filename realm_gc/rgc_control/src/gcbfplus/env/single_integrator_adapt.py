...
class SingleIntegratorAdapt(MultiAgentEnv):
    ...
    def __init__(
        ...
        super(SingleIntegratorAdapt, self).__init__(num_agents, area_size, max_step, max_travel, dt, params)
    ...
    def get_graph(self, state: EnvState) -> GraphsTuple:
        ...
        node_type = node_type.at[: self.num_agents].set(SingleIntegratorAdapt.AGENT)
        node_type = node_type.at[self.num_agents: self.num_agents * 2].set(SingleIntegratorAdapt.GOAL)
        node_type = node_type.at[-n_hits-self._params["n_mov_obs"]: -self.params["n_mov_obs"]].set(SingleIntegratorAdapt.OBS)
        node_type = node_type.at[-self._params["n_mov_obs"]:-self._params["n_mov_obs"] // 2].set(SingleIntegratorAdapt.SLOW_MOV_OBS)
        node_type = node_type.at[-self._params["n_mov_obs"] // 2:].set(SingleIntegratorAdapt.FAST_MOV_OBS)
