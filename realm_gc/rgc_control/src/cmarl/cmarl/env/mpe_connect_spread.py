...
class MPEConnectSpread(MPESpread):
    ...
    def reset(self, key: Array) -> GraphsTuple:
        # solve side length for the initialization area
        # side_length = self.area_size / 2 - (self.params["obs_radius"] + self.params["car_radius"]) / jnp.sqrt(2)
        ...
        # obs = jnp.array([[self.area_size / 2, self.area_size / 2]])
