...
class CrazyFlie(MultiAgentEnv):
    ...
    def render_video(
        ...
        render_mpe(rollout=rollout, video_path=video_path, side_length=self.area_size, dim=3, n_agent=self.num_agents,
                   n_rays=self.n_rays, r=self.params["drone_radius"], Ta_is_unsafe=Ta_is_unsafe, viz_opts=viz_opts,
                   dpi=dpi, **kwargs)
