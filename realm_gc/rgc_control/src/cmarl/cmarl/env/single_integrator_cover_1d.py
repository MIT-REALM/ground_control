...
class SingleIntegratorCover1D(MultiAgentEnv):
    """
    ...
    def __init__(
        ...
        area_size = SingleIntegratorCover1D.PARAMS["default_area_size"] if area_size is None else area_size
        super(SingleIntegratorCover1D, self).__init__(num_agents, area_size, max_step, max_travel, dt, params)
    ...
    def get_graph(self, state: EnvState) -> GraphsTuple:
        ...
        node_type = node_type.at[self.num_agents: self.num_agents * 2].set(SingleIntegratorCover1D.GOAL)
