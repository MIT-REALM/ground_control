...
class ObstacleMAFStateEstimator(StateEstimator):
    """
    State estimator for generic obstacle using a Moving Average Filter.
    """

    def __init__(self):
        super(ObstacleMAFStateEstimator, self).__init__()
...
if __name__ == "__main__":
    try:
        maf_node = ObstacleMAFStateEstimator()
        maf_node.run()
